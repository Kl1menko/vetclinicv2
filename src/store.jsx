...
const buildMedicalRecordFromAppointment = (appointment, existingId = null) => ({
  ...
  testsOrdered: appointment.testsOrdered || '',
  followUpDate: appointment.followUpDate || '',
  followUpPlan: appointment.followUpPlan || '',
  dischargeSummary: appointment.dischargeSummary || '',
  ...
  const actions = useMemo(() => ({
    ...
    addAppointment: (payload = {}) => {
      ...
      const appointment = appointmentPaidPatch({
        ...
        medicationSchedule: payload.medicationSchedule || '',
        testsOrdered: payload.testsOrdered || '',
